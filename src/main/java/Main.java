...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("What type of currency are you exchanging today? Please select a number: \n 1: US Dollars \n 2: Euros \n 3: British Pound \n 4: Indian Rupees " +
                "\n 5: Australian Dollars \n 6: Canadian Dollars \n 7: Singapore Dollars \n 8: Swiss Franc \n 9: Malaysian Ringgits \n 10: Japanese Yen \n 11: Chinese Yuan Renminbi");
        int input = exchange.nextInt();

        if(input >= 12){

            System.out.println("How much currency you want to exchange?");
        ...
        converter.convertToUSD(moneyToConvert, input);

        System.out.println("What type of currency are you converting to? Please select a number: \n 1: US Dollars \n 2: Euros \n 3: British Pound \n 4: Indian Rupees " +
                "\n 5: Australian Dollars \n 6: Canadian Dollars \n 7: Singapore Dollars \n 8: Swiss Franc \n 9: Malaysian Ringgits \n 10: Japanese Yen \n 11: Chinese Yuan Renminbi \n 12: Return to Start");
